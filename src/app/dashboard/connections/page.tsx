...
export default function DashboardContactPage() {
  ...
  useEffect(() => {
    setHasUnreadRequests(
      connectionRequests.length > 0 && activeTab !== "requests"
    );
          ...
          <div className={styles.heroContentWrapper}>
            ...
            <div className={styles.headerFlexContainer}>
              <div className={styles.flexOne}>
                ...
                <div
                  className={`${styles.mobileOnly} ${styles.hiddenInHeader}`}
                >
                  <div className={styles.viewToggleContainer}>
                    <div
                      className={`${styles.viewToggleBackground} ${
                        viewMode === "table"
                          ? styles.viewToggleTableActive
                          : styles.viewToggleCardsActive
                      }`}
                    />
                    <button
              ...
              <div
                className={`${styles.controlsFlexContainer} ${styles.hiddenInHeader}`}
              >
                ...
                <div className={styles.searchBarInner}>
                  ...
                  <div className={styles.mobileOnly}>
                    <div className={styles.viewToggleContainer}>
                      ...
                      >
                        <span className={styles.flexCenter}>Table View</span>
                      </button>
                      <button
                        onClick={() => setViewMode("cards")}
                        className={`${styles.viewToggleButton} ${
                      ...
                      >
                        <span className={styles.flexCenter}>Cards View</span>
                      </button>
                    </div>
                  </div>
                      ...
                      <div className={styles.filterContainer} ref={filterRef}>
                        ...
                        {isFilterOpen && (
                          <div className={styles.filterDropdown}>
                            <button onClick={() => setSortBy("a-z")}>
                              Sort A–Z
                            </button>
                            <button onClick={() => setSortBy("z-a")}>
                              Sort Z–A
                            </button>
                            ...
                            <div className={styles.relativeContainer}>
                              ...
                              {openDropdown === contact.id && (
                                <div className={styles.dropdownMenu}>
                                  <button
                                    onClick={() =>
                                      handleDeleteConnection(contact.id)
                                    }
                            ...
                            <div className={styles.mobileCardHeader}>
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  {contact.title && (
                                    <p
                                      className={styles.mobileCardSubtitle}
                                      style={{
                                        display: "block",
                                        maxWidth: 240,
                                        whiteSpace: "normal",
                                  ...
                                  {openDropdown === contact.id && (
                                    <div className={styles.dropdownMenuMobile}>
                                      <button
                                        ...
                                        className={
                                          styles.dropdownItemDeleteMobile
                                        }
                                      >
                                        <svg
                                          className={styles.dropdownIcon}
                              ...
                              showContactInfo[contact.id]?.type && (
                                <div className={styles.mobileContactInfoBox}>
                                  <div className={styles.mobileContactInfoText}>
                                    <span
                                      className={styles.mobileContactInfoLabel}
                                    >
                                      {showContactInfo[contact.id]?.type ===
                                      "phone"
                                        ? "Phone: "
                                    ...
                                    <span
                                      className={styles.mobileContactInfoValue}
                                    >
                                      {showContactInfo[contact.id]?.type ===
                                      "phone"
                                        ? contact.phone
                    ...
                    {sortedContacts.map((contact, index) => (
                      <div
                        ...
                        onClick={(e) => {
                          ...
                          if (
                            target.closest(`.${styles.quickActionBtn}`) ||
                            target.closest(`.${styles.quickInfoBox}`)
                          ) {
                            e.stopPropagation();
                            return;
                            ...
                            >
                              ...
                              <div
                                ...
                                style={{
                                  ...
                                  flexDirection: "row",
                                  alignItems:
                                    "flex-start" /* top-align avatar and text block */,
                                  justifyContent: "flex-start",
                                  gap: "12px",
                                  padding:
                                    "14px 12px 10px 12px" /* added extra top padding */,
                                  height: "auto",
                                }}
                              >
                                {/* Left: Avatar */}
                                ...
                                <div className={styles.desktopOnly}>
                                  {showContactInfo[contact.id]?.type ? (
                                    <div className={styles.quickActionsRow}>
                                      <button
                                        onClick={() =>
                                          handleContactInfo(contact.id, "email")
                                        }
                                        className={`${styles.quickActionBtn} ${
                                          styles.quickActionInline
                                        } ${
                                          showContactInfo[contact.id]?.type ===
                                          "email"
                                            ? styles.quickActionBtnActive
                                            : ""
                                        }`}
                                      ...
                                      <button
                                        onClick={() =>
                                          handleContactInfo(contact.id, "phone")
                                        }
                                        className={`${styles.quickActionBtn} ${
                                          styles.quickActionInline
                                        } ${
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          ...
                          className={`${styles.requestApproveButton} flex items-center justify-center`}
                        >
                          {/* Mobile icon */}
                        ...
                        <button
                          ...
                          className={`${styles.requestRejectButton} flex items-center justify-center`}
                        >
                          {/* Mobile icon */}
                          <span className="sm:hidden">
                            <Trash2 size={18} />
            ...
            <div className={styles.modalContent}>
              <div className={styles.modalHeader}>
                <h3 className={styles.modalTitle}>
                  New Message to {messageModal.contact.name}
                </h3>
                <button
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
                ...
                <button
                  onClick={() => {
                    const id = approveModal.request!.id;
                    closeApproveModal();
